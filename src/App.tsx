...
import { ChildFriendlyBackground } from './components/ChildFriendlyBackground' // Import ChildFriendlyBackground

function App() {
  return (
    <ChildFriendlyBackground> {/* Wrap the entire app with the background */}
      <AuthProvider>
        <Router>
          <Routes>
